...
const Footer = () => {
    return (
        <>
            <footer className="footer flex flex-col items-center justify-center  text-[#7092a1] smallText shadow-2xl ">
                <div className="container max-w-[1200px] flex flex-col gap-5 py-10 border-t-4 border-[#0d3f52] px-5 md:px-0">
